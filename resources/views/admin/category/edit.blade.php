...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form class="needs-validation" action="{{ url('admin/category', ['id'=>$categories->id]) }}" novalidate method="POST">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input"  name="active" type="checkbox" {{ $categories->active ? 'checked' : '' }} id="categoryActive">
