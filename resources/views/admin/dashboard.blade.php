            ...
            <div class="card-body p-4">
                <div class="media ai-icon">
                    <span class="mr-3 bgl-primary text-primary">
                        <!-- <i class="ti-user"></i> -->
                        <svg width="50" height="30" viewBox="0 0 36 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <div class="widget-stat card">
            <div class="card-body p-4">
                <div class="media ai-icon">
                    ...
                    <div class="media-body">
                        <h3 class="mb-0 text-black"><span class="counter ml-0">{{$revenue}}</span>K</h3>
        ...
        <div class="widget-stat card">
            <div class="card-body p-4">
                <div class="media ai-icon">
                    ...
                    <div class="media-body">
                        <h3 class="mb-0 text-black"><span class="counter ml-0">{{$commoncity[0]->location_city}}</span></h3>
                        <p class="mb-0">Total Cities Selling</p>
                        <small>All</small>
                    </div>
                </div>
            </div>
