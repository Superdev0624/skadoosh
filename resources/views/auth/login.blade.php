                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted">Sign in to continue to JobFinder.</p>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'wangjian72223@gmail.com') }}" id="username" placeholder="Enter Email" autocomplete="email" autofocus>
                                                @error('email')
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">© <script>
                                        ...
                                        </script> JobFinder. Crafted with <i class="mdi mdi-heart text-danger"></i> by
                                        MMC</p>
                                </div>
                            </div>
